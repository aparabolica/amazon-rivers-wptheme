...
function arp_scripts() {
  ...
  wp_register_style('main', get_template_directory_uri() . '/css/main.css', array('webfont-raleway', 'normalize', 'skeleton', 'fontawesome', 'perfect-scrollbar'), '0.1.2');
  ...
  wp_register_script('site', get_template_directory_uri() . '/js/site.js', array('jquery', 'fitvids', 'perfect-scrollbar'), '0.1.3');
